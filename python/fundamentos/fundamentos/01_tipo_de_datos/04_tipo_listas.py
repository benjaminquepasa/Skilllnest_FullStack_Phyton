...
# Indice en las listas (indice es un método incorporado que localiza la posición de la primera aparición de un elemento en una lista, tupla o cadena, devolviendo su índice numérico)
...
# Funcion largo de caratecteres len
vocales = ['a', 'e', 'i', 'o', 'u']
